...
const KANJI_DATA = {
  ...
  N4: [
    ...
    },
    {
      ...
      examples: [
        { word: "奥さん", reading: "おくさん", meaning: "(남의) 부인, 아내" },
      ],
    },
    {
      kanji: "私",
    ...
    },
    {
      ...
      kunyomi: [],
      examples: [
        { word: "洋服", reading: "ようふく", meaning: "양복, 서양식 옷" },
      ],
    },
    {
      kanji: "料",
    ...
    },
    {
      ...
      examples: [
        { word: "止まる", reading: "とまる", meaning: "멈추다, 멈춰서다" },
      ],
    },
    {
      kanji: "急",
    ...
    },
    {
      ...
      examples: [
        { word: "早い", reading: "はやい", meaning: "(시간이) 이르다" },
      ],
    },
    {
      kanji: "速",
      ...
      examples: [
        { word: "速い", reading: "はやい", meaning: "(속도가) 빠르다" },
      ],
    },
    {
      kanji: "遅",
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "코노 혼와 니혼고데 카이테아리마스.",
          kr: "이 책은 일본어로 쓰여 있습니다.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "코노 각코-니와 각세-가 타쿠상 이마스.",
          kr: "이 학교에는 학생이 많이 있습니다.",
        },
        {
          segments: [
            { t: "学生", r: "がくせい" },
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "와타시노 이에와 카이샤카라 토오쿠나이데스.",
          kr: "제 집은 회사에서 멀지 않습니다.",
        },
        {
          segments: [
            { t: "遠", r: "とお" },
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "코노 마치와 아메노 히가 오오이데스.",
          kr: "이 마을은 비 오는 날이 많습니다.",
        },
        {
          segments: [
            { t: "宿題", r: "しゅくだい" },
        ...
        },
        {
          ...
          pron: "코노 미세와 오캬쿠상가 오오쿠나이데스.",
          kr: "이 가게는 손님이 많지 않습니다.",
        },
        {
          segments: [
            { t: "去年", r: "きょねん" },
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "이로이로 캉가에마시타가, 와카리마센.",
          kr: "여러 가지로 생각했지만 모르겠습니다.",
        },
        {
          segments: [
            { t: "この" },
          ...
          pron: "코노 미세니와 이로이로나 료-리가 아리마스.",
          kr: "이 가게에는 다양한 요리가 있습니다.",
        },
      ],
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "코노 카와와 아마리 키레-쟈나이데스.",
          kr: "이 강은 별로 깨끗하지 않습니다.",
        },
        {
          segments: [
            { t: "彼女", r: "かのじょ" },
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "카레와 나니모 이이마센데시타.",
          kr: "그는 아무 말도 하지 않았습니다.",
        },
        {
          segments: [
            { t: "すみませんが、" },
          ...
          pron: "스미마센가, 모- 이치도 잇테쿠다사이.",
          kr: "죄송하지만 한 번 더 말해 주세요.",
        },
        {
          segments: [
            { t: "先生", r: "せんせい" },
          ...
          pron: "센세-가 아시타 시켄가 아루토 이이마시타.",
          kr: "선생님이 내일 시험이 있다고 말했습니다.",
        },
        {
          segments: [
            { t: "本当", r: "ほんとう" },
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "오카네가 나쿠테 나니모 카에마센데시타.",
          kr: "돈이 없어서 아무것도 사지 못했습니다.",
        },
        {
          segments: [
            { t: "この" },
          ...
          pron: "코노 미세데 야사이오 카이마센카.",
          kr: "이 가게에서 채소를 사지 않겠습니까?",
        },
        {
          segments: [
            { t: "友", r: "とも" },
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "아메가 훗테이루노데 하야쿠 카에리마쇼-.",
          kr: "비가 오고 있으니 일찍 돌아갑시다.",
        },
        {
          segments: [
            { t: "母", r: "はは" },
    ...
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          pron: "이츠모노 미세데 코-히-오 노미마시타.",
          kr: "늘 가던 가게에서 커피를 마셨습니다.",
        },
        {
          segments: [
            { t: "彼女", r: "かのじょ" },
      ...
      examples: [
        {
          ...
          pron: "아메데시타. 데모, 데카케마시타.",
          kr: "비가 왔습니다. 하지만 외출했습니다.",
        },
        {
          segments: [
            { t: "高", r: "たか" },
        ...
        },
        {
          ...
          pron: "츠카레마시타. 데모, 마다 시고토가 오와리마센.",
          kr: "피곤합니다. 하지만 아직 일이 끝나지 않았습니다.",
        },
        {
          segments: [
            { t: "好", r: "す" },
          ...
          pron: "스키데스. 데모, 지칸가 아리마센.",
          kr: "좋아합니다. 하지만 시간이 없습니다.",
        },
      ],
    },
    {
      ...
      examples: [
        {
          ...
          pron: "아사고항오 타베마시타. 소시테, 각코-에 이키마시타.",
          kr: "아침을 먹었습니다. 그리고 학교에 갔습니다.",
        },
        {
          segments: [
            { t: "宿題", r: "しゅくだい" },
          ...
          pron: "슈쿠다이오 시마시타. 소시테, 네마시타.",
          kr: "숙제를 했습니다. 그리고 잤습니다.",
        },
        {
          segments: [
            { t: "彼", r: "かれ" },
          ...
          pron: "카레와 이샤데스. 소시테, 토테모 신세츠데스.",
          kr: "그는 의사입니다. 그리고 매우 친절합니다.",
        },
        {
          segments: [
            { t: "部屋", r: "へや" },
          ...
          pron: "헤야오 소-지시마시타. 소시테, 센타쿠모 시마시타.",
          kr: "방을 청소했습니다. 그리고 빨래도 했습니다.",
        },
        {
          segments: [
            { t: "京都", r: "きょうと" },
          ...
          pron: "쿄-토에 이키마시타. 소시테, 오-사카니모 이키마시타.",
          kr: "교토에 갔습니다. 그리고 오사카에도 갔습니다.",
        },
      ],
    },
    {
      ...
      examples: [
        {
          ...
          pron: "샤와-오 아비마시타. 소레카라, 네마시타.",
          kr: "샤워를 했습니다. 그러고 나서 잤습니다.",
        },
        {
          segments: [
            { t: "手", r: "て" },
          ...
          pron: "테오 아라이마시타. 소레카라, 고항오 타베마시타.",
          kr: "손을 씻었습니다. 그러고 나서 밥을 먹었습니다.",
        },
        {
          segments: [
            { t: "銀行", r: "ぎんこう" },
          ...
          pron: "긴코-니 이키마시타. 소레카라, 유-빙쿄쿠니모 이키마시타.",
          kr: "은행에 갔습니다. 그러고 나서 우체국에도 갔습니다.",
        },
        {
          segments: [
            { t: "宿題", r: "しゅくだい" },
          ...
          pron: "슈쿠다이오 시마시타. 소레카라, 테레비오 미마시타.",
          kr: "숙제를 했습니다. 그러고 나서 텔레비전을 봤습니다.",
        },
        {
          segments: [
            { t: "駅", r: "えき" },
          ...
          pron: "에키데 토모다치니 아이마시타. 소레카라, 잇쇼니 에-가오 미마시타.",
          kr: "역에서 친구를 만났습니다. 그러고 나서 함께 영화를 봤습니다.",
        },
      ],
    },
    {
      ...
      examples: [
        {
          ...
          pron: "아메데스. 다카라, 카사오 못테 이키마스.",
          kr: "비가 옵니다. 그래서 우산을 가지고 갑니다.",
        },
        {
          segments: [
            { t: "明日", r: "あした" },
          ...
          pron: "아시타와 시켄데스. 다카라, 콘반 벤쿄-시마스.",
          kr: "내일은 시험입니다. 그래서 오늘 밤 공부합니다.",
        },
        {
          segments: [
            { t: "頭", r: "あたま" },
          ...
          pron: "아타마가 이타이데스. 다카라, 쿠스리오 노미마시타.",
          kr: "머리가 아픕니다. 그래서 약을 먹었습니다.",
        },
        {
          segments: [
            { t: "安", r: "やす" },
      ...
      examples: [
        {
          ...
          pron: "감바리마시타. 시카시, 싯파이시마시타.",
          kr: "열심히 했습니다. 하지만 실패했습니다.",
        },
        {
          segments: [
            { t: "天気", r: "てんき" },
          ...
          pron: "텐키와 와루이데스. 시카시, 데카케마스.",
          kr: "날씨는 나쁩니다. 하지만 외출합니다.",
        },
        {
          segments: [
            { t: "難", r: "むずか" },
        ...
        },
        {
          ...
          pron: "덴와시마시타. 시카시, 다레모 데마센데시타.",
          kr: "전화했습니다. 하지만 아무도 받지 않았습니다.",
        },
        {
          segments: [
            { t: "高", r: "たか" },
          ...
          pron: "타카이데스. 시카시, 시츠와 이이데스.",
          kr: "비쌉니다. 하지만 품질은 좋습니다.",
        },
      ],
    },
    {
...
export default function App() {
            ...
            >
              <div className="bg-white w-full rounded-3xl shadow-sm border border-slate-200 overflow-hidden mb-6 flex flex-col items-center p-8">
                <div className="relative w-48 h-48 border border-slate-200 bg-slate-50 rounded-2xl flex justify-center items-center mb-2">
                  ...
                  <SpeakButton
                    text={
                      activeKanji.examples?.[0]?.reading || activeKanji.kanji
                    }
                    iconSize={14}
                    diameter={30}
  ...
  const buildTranslatePool = (selectedItems) => {
    ...
    let tokenUniverse = [...new Set(candidates.flatMap((c) => c.tokens))];
    ...
    return candidates.map(({ item, ex, tokens }) => {
      const distractorSource = tokenUniverse.filter((t) => !tokens.includes(t));
  ...
  const buildMatchPool = (selectedItems) => {
    ...
    if (
      groups.length > 1 &&
      groups[groups.length - 1].length < MATCH_MIN_GROUP_SIZE
    ) {
  ...
  const buildTestPool = (ignoreSelection = false) => {
    const isSelected = (val) =>
      ignoreSelection || selectedTestItems.includes(val);
    let pool = [];
    if (testType === "hiragana") {
      KANA_DATA.forEach((row) => {
              ...
              <div className="flex flex-col gap-4 p-5">
                ...
                {!isRevealed && (
                  <div className="flex flex-wrap gap-2 justify-center pt-2 border-t border-dashed border-slate-200">
                    {currentQuestion.tiles
                      .filter((t) => !placedTiles.some((p) => p.id === t.id))
                      .map((t) => (
                        <button
                          key={t.id}
                ...
                {!isRevealed && (
                  <button
                    disabled={
                      placedTiles.length !==
                      currentQuestion.correctTokens.length
                    }
